...
const PAGES: Array<{ id: Page; label: string; path: string }> = [
  ...
  { id: "source", label: "上游与日志", path: "M12 3v12m0 0l-4-4m4 4l4-4M4 19h16" },
  { id: "apps", label: "已入库", path: "M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" },
  { id: "lua", label: "Lua 目录", path: "M3 7a2 2 0 012-2h4l2 2h8a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2z" },
